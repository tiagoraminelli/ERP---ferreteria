                                ...
                                <div>
                                    ...
                                    <select name="estado" id="estado"
                                        ...
                                        <option value="completada"
                                            {{ old('estado') == 'completada' ? 'selected' : '' }}>Completada</option>
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <input type="number" step="0.01" id="monto_pagado" name="monto_pagado"
                                        value="{{ old('monto_pagado', 0) }}" oninput="calcularSaldoPendiente()"
                                ...
                                <div style="text-align:right">
                                    ...
                                    <div id="saldoPendiente"
                                        style="display:none;color:#c00;font-size:14px;margin-top:5px">
                                        Saldo $0.00
                                    </div>
                                </div>
                            </div>
