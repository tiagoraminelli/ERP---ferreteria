        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-white-500 dark:text-gray-400">
                    Registro de presupuesto y productos
                </p>
            </div>
...
'{{ $producto->precio }}'
                            ...
                            <div style="display:grid;grid-template-columns:1fr 1fr;gap:15px">
                                ...
                                <div style="grid-column:span 2">
                                    ...
                                    <textarea name="observaciones" rows="2"
                                        style="width:100%;padding:8px;border:1px solid #ddd;border-radius:4px;box-sizing:border-box">{{ old('observaciones') }}</textarea>
                                </div>
                            ...
                            <div style="overflow-x:auto">
                                <table style="width:100%;border-collapse:collapse;font-size:14px">
                                    ...
                                    <tbody id="tablaProductos">
                                        @if (old('productos'))
                                            @foreach (old('productos') as $index => $item)
                                                @php
                                                ...
                                                @if ($producto)
                                                    <tr>
                                                        ...
                                                        <td class="subtotal"
                                                            style="text-align:right;padding:10px;font-weight:500">0.00
                                                        </td>
                                                        <td style="padding:10px">
                                                            <button type="button"
    ...
    <script>
        let indexProducto = {{ old('productos') ? count(old('productos')) : 0 }}
        ...
        $(document).ready(function() {
            ...
            // Inicializar contador y cálculos si hay productos guardados
            actualizarContador();
